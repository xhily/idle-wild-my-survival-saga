...
export const useGameStore = defineStore('game', {
  state: () => ({
    ...
    recipes: [
      ...
      // 探索配方
      {
        id: 'explore_forest',
        name: '探索森林',
        inputs: { energy: 30, food: 2, water: 2 },
        outputs: { wood: [10, 20], herb: [2, 5], food: [0, 5] },
        duration: 300,
      ...
      },
      {
        id: 'explore_hills',
        name: '探索丘陵',
        inputs: { energy: 40, food: 3, water: 3 },
        outputs: { stone: [10, 20], metal: [1, 3] },
        duration: 360,
      ...
      },
      {
        id: 'explore_ruins',
        name: '探索废墟',
        inputs: { energy: 50, food: 5, water: 5, medicine: 1 },
        outputs: { metal: [5, 10], parts: [0, 2], techFragment: [0, 1], ancientRelic: [0, 1] },
        duration: 480,
        skillRequired: { survival: 4, combat: 2 },
        category: 'exploration'
      },
      // 研究配方
      {
  ...
  actions: {
    ...
    completeActivity(activityId) {
      ...
      const recipe = this.recipes.find(r => r.id === activity.recipeId)
      // 移除活动
